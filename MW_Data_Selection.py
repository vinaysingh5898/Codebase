...
fname = '../SourceData/sub-01/eeg/sub-01_ses-1_task-BreathCounting_eeg.bdf'

#fname = 'sub-01_ses-01_task-BreathCounting_eeg.bdf'

#fname = 'sub-01_ses-1_task-BreathCounting_eeg.bdf'
